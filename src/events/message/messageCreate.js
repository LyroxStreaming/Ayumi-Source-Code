  ...
  if (
    ...
    let row = new Discord.MessageActionRow().addComponents(
      new Discord.MessageButton()
        .setLabel("Invite")
        .setURL(
          "https://discord.com/api/oauth2/authorize?client_id=1057350197610557520&permissions=4398046511095&scope=bot"
        )
        .setStyle("LINK"),

      new Discord.MessageButton()
        .setLabel("Support server")
        .setURL("https://discord.gg/tsmv2CyxUT")
        .setStyle("LINK")
    );
    ...
    client
      .embed(
        {
          title: "Hi, i'm AyuMi💖 Bot",
          desc: `Use with commands via Discord ${client.emotes.normal.slash} commands`,
          fields: [
           {
                name: "📢┆More Info",
                value: 'For More Information Join [This Server](https://discord.gg/tsmv2CyxUT)',
                inline: false,
            },
            {
              name: "📨┆Invite me",
