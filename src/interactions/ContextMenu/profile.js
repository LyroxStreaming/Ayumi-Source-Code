        ...
        Schema.findOne({ User: user.id }, async (err, data) => {
            if (data) {
                ...
                client.embed({
                    ...
                    fields: [
                      {
                        name: "<:member:1025604397201375243>┆User",
                        value: user.user.username,
                        inline: true
                    },
                    {
                        name: "<:uo_paper:1030342446812500098>┆Discriminator",
                        value: user.user.discriminator,
                        inline: true
                    },
                    {
                        name: "<:emote:1030387549656596511>┆ID",
                        value: user.user.id,
                        inline: true
                    },
                    {
                        name: "<:emote:1030387549656596511>┆Gender",
                        value: `${data.Gender || 'Not set'}`,
                        inline: true
                    },
                    {
                        name: "<:emote:1030387549656596511>┆Age",
                        value: `${data.Age || 'Not set'}`,
                        inline: true
                    },
                    {
                        name: "<:emote:1030387549656596511>┆Birthday",
                        value: `${data.Birthday || 'Not set'}`,
                        inline: true
                    },
                    {
                        name: "<:emote:1030387549656596511>┆Favorite color",
                        value: `${data.Color || 'Not set'}`,
                        inline: true
                    },
                    {
                        name: "<:emote:1030387549656596511>┆Favorite pets",
                        value: `${data.Pets.join(', ') || 'Not set'}`,
                        inline: true
                    },
                    {
                        name: "<:emote:1030387549656596511>┆Favorite food",
                        value: `${data.Food.join(', ') || 'Not set'}`,
                        inline: true
                    },
                    {
                        name: "<:uo_music:1030336901443502090>┆Favorite songs",
                        value: `${data.Songs.join(', ') || 'Not set'}`,
                        inline: true
                    },
                    {
                        name: "<:emote:1030387549656596511>┆Favorite artists",
                        value: `${data.Artists.join(', ') || 'Not set'}`,
                        inline: true
                    },
                    {
                        name: "<:uo_clock:1030343693183488030>┆Favorite movies",
                        value: `${data.Movies.join(', ') || 'Not set'}`,
                        inline: true
                    },
                    {
                        name: "<:emote:1030387549656596511>┆Favorite actors",
                        value: `${data.Actors.join(', ') || 'Not set'}`,
                        inline: true
                    },
                    {
                        name: "<:emote:1030387549656596511>┆Origin",
                    ...
                    {
                        name: "<:emote:1030387549656596511>┆Status",
                        value: `${data.Status || 'Not set'}`,
                        inline: true
                    },
                    {
                        name: "<:emote:1030387549656596511>┆Bot Badges",
                        value: `${Badges.FLAGS ? Badges.FLAGS.map(flag => badgeFlags[flag]).join(' ') : 'None'}`,
                        inline: true
                    },
                    {
                        name: "<:emote:1030387549656596511>┆Discord Badges",
                        value: `${userFlags.length ? userFlags.map(flag => flags[flag]).join(', ') : 'None' || 'None'}`,
                        inline: true
                    },
                    {
                        name: "<:emote:1030387549656596511>┆Dcredits",
                        value: `${credits || 'None'}`,
                        inline: true
                    },
                    {
