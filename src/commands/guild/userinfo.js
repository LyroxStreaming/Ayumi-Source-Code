...
module.exports = async (client, interaction, args) => {
  ...
  return client.embed({
    title: `<:member:1025604397201375243>・User information`,
    desc: `Information about ${member.user.username}`,
    thumbnail: member.user.displayAvatarURL({ dynamic: true, size: 1024 }),
    image: url,
    fields: [
      {
        name: "<a:emote:1030387549656596511> ┆ Username",
        value: `${member.user.username}`,
        inline: true,
      },
      {
        name: "<a:emote:1030387549656596511> ┆ Discriminator",
        value: `${member.user.discriminator}`,
        inline: true,
      },
      {
        name: "<a:emote:1030387549656596511> ┆ Nickname",
      ...
      {
        name: "<a:emote:1030387549656596511> ┆ Flags",
        value: `${userFlags.length ? userFlags.map(flag => flags[flag]).join(', ') : 'None'}`,
        inline: true,
      },
      {
        name: "<a:emote:1030387549656596511> ┆ Badges",
        value: `${Badges.FLAGS ? Badges.FLAGS.map(flag => badgeFlags[flag]).join(' ') : 'None'}`,
        inline: true,
      },
      {
        name: "<a:emote:1030387549656596511> ┆ Discord joined at",
        value: `<t:${Math.round(member.user.createdTimestamp / 1000)}>`,
        inline: true,
      },
      {
        name: "<a:emote:1030387549656596511> ┆ Server joined at",
        value: `<t:${Math.round(member.joinedAt / 1000)}>`,
        inline: true,
      },
      {
        name: `<a:emote:1030387549656596511> ┆ Roles [${roles.length}]`,
        value: `${roles.join(', ')}`,
        inline: false,
      }
    ],
